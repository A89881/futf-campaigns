              ...
              <div class="bg-futf-blue text-white rounded-lg p-6">
                ...
                <div class="flex space-x-4">
                  <a href="https://www.instagram.com/abbebabbe07/" target="_blank" rel="noopener noreferrer"
                    class="bg-white/10 text-white p-3 rounded-full hover:bg-white/20 transition-colors" aria-label="Instagram">
                    <!-- Instagram icon -->
                  ...
                  <a href="https://www.linkedin.com/in/abhay-mishra-5aa78319a/" target="_blank" rel="noopener noreferrer"
                    class="bg-white/10 text-white p-3 rounded-full hover:bg-white/20 transition-colors" aria-label="LinkedIn">
                    <!-- LinkedIn icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
